...
A SCARA robot arm picks a component from a feeder tray and places it on a PCB pad with sub-millimeter accuracy. To do that, the controller must convert a target position in board coordinates into the joint angles that move the end-effector there, accounting for link lengths, joint offsets, and the orientation of every frame in the chain. That conversion is built entirely on 2D transformation matrices. Get the math wrong and the arm places the component on the wrong pad or crashes into the board. In this lesson you will learn planar transformations through SCARA robot programming: complex number rotations, 2D rotation matrices, and forward and inverse kinematics for precision pick-and-place. #PlanarTransformations #SCARA #Kinematics

## Learning Objectives

By the end of this lesson, you will be able to:

1. **Apply** complex number mathematics for elegant 2D rotation calculations using $e^{i\theta}$
...
<Card title="🔄 2D Rotation Matrix" icon="document">
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![PCB Assembly SCARA Robot](https://cdn.siliconwit.com/education/spatial-mechanics/scara-robot.jpg)
  </TailwindWrapper>
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![SCARA Robot Configuration](https://cdn.siliconwit.com/education/spatial-mechanics/scara-configuration-diagram.png)
  </TailwindWrapper>
</div>
**Given:**
...
2. **Total end-effector position:**
   ...
   **Separating real and imaginary parts:**
   ...
   $$y = 350\sin\theta_1 + 250\sin(\theta_1 + \theta_2)$$ ✅
...
4. **Tool orientation:**
   ...
   Total tool angle: $\phi_{tool} = \theta_1 + \theta_2 + \phi_{wrist}$ ✅
...
1. **Geometric inverse kinematics for pick position (450, 200):**
   ...
   **Distance from base:**
   $$r = \sqrt{x^2 + y^2} = \sqrt{450^2 + 200^2} = \sqrt{202500 + 40000} = \sqrt{242500} = 492.55 \text{ mm}$$ ✅
...
2. **Elbow angle $\theta_2$ calculation using law of cosines:**
   ...
   $$\cos\theta_2 = \frac{242605 - 122500 - 62500}{175000} = \frac{57605}{175000} = 0.329$$ ✅

   **Two solutions:**
   - **Elbow-up:** $\theta_2 = +\arccos(0.329) = +70.78°$ ✅
   - **Elbow-down:** $\theta_2 = -\arccos(0.329) = -70.78°$ ✅

3. **Shoulder angle $\theta_1$ calculation (elbow-up configuration):**

   $$\beta = \arctan2(y, x) = \arctan2(200, 450) = 23.96°$$ ✅

   $$\alpha = \arctan2(L_2\sin\theta_2, L_1 + L_2\cos\theta_2)$$

   $$\alpha = \arctan2(250\sin(70.78°), 350 + 250\cos(70.78°))$$

   $$\alpha = \arctan2(235.99, 350 + 82.25) = \arctan2(235.99, 432.25) = 28.59°$$ ✅

   **Shoulder angle:**
   $$\theta_1 = \beta - \alpha = 23.96° - 28.59° = -4.63°$$ ✅

4. **Verification using forward kinematics:**

   $$x = 350\cos(-4.63°) + 250\cos(66.15°) = 350(0.9968) + 250(0.4051)$$
   $$x = 348.88 + 101.28 = 450.16 \text{ mm}$$ ✅ (within 0.16 mm)

   $$y = 350\sin(-4.63°) + 250\sin(66.15°) = 350(-0.0807) + 250(0.9142)$$
   $$y = -28.25 + 228.55 = 200.30 \text{ mm}$$ ✅ (within 0.30 mm)
...
1. **Pick orientation (tray at 30°):**
   ...
   $$\phi_{wrist,pick} = 30° - (-4.63°) - 70.78° = 30° + 4.63° - 70.78° = -36.15°$$ ✅
...
2. **Place orientation (PCB at -45° with component rotated 75°):**
   ...
   **Corrected logic:**
   ...
   - Final orientation: $30° + 75° = 105°$ ✅

3. **Place position inverse kinematics (-200, 300) mm:**

   $$r = \sqrt{(-200)^2 + 300^2} = \sqrt{40000 + 90000} = \sqrt{130000} = 360.56 \text{ mm}$$ ✅

   $$\cos\theta_2 = \frac{360.56^2 - 350^2 - 250^2}{2(350)(250)} = \frac{130003 - 122500 - 62500}{175000} = \frac{-54997}{175000} = -0.3143$$ ✅

   **Elbow angle:**
   $$\theta_2 = \arccos(-0.3143) = 108.33°$$ ✅ (elbow-up configuration)

   $$\beta = \arctan2(300, -200) = 123.69°$$ ✅

   $$\alpha = \arctan2(250\sin(108.33°), 350 + 250\cos(-0.3143))$$
   $$\alpha = \arctan2(237.08, 350 - 78.57) = \arctan2(237.08, 271.43) = 41.12°$$ ✅

   $$\theta_1 = 123.69° - 41.12° = 82.57°$$ ✅

4. **Wrist angle for place:**

   $$\phi_{wrist,place} = 105° - 82.57° - 108.33° = 105° - 190.90° = -85.90°$$ ✅
...
5. **Summary table:**
   ...
   **Component rotation during transfer:** $105° - 30° = 75°$ ✅ (matches requirement)
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![CNC Router Elliptical Path](https://cdn.siliconwit.com/education/spatial-mechanics/cnc-elliptical-path.png)
  </TailwindWrapper>
</div>
**What we need to calculate:**
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![CNC Ellipse Parameters](https://cdn.siliconwit.com/education/spatial-mechanics/cnc-ellipse-diagram.png)
  </TailwindWrapper>
</div>
**Given:**
...
1. **Basic parametric ellipse (unrotated, centered at origin):**
   ...
   **Example at t = 0°:**
   $$z(0) = 80 + i \cdot 0 = 80 + 0i$$ ✅ (rightmost point)

   **Example at t = 90°:**
   $$z(90°) = 0 + i \cdot 50$$ ✅ (topmost point)

2. **Rotation by α = 25° using complex multiplication:**

   **Rotation operator:**
   $$e^{i\alpha} = e^{i25°} = \cos(25°) + i\sin(25°) = 0.9063 + 0.4226i$$ ✅
   ...
   **Separating into x and y:**
   $$x_{rot}(t) = 72.50\cos(t) - 21.13\sin(t)$$ ✅
   $$y_{rot}(t) = 33.81\cos(t) + 45.32\sin(t)$$ ✅
...
3. **Translation to center (150, 100):**
   ...
   **Final parametric equations:**
   ...
   $$y(t) = 100 + 33.81\cos(t) + 45.32\sin(t)$$ ✅

4. **Verification at t = 0°:**

   $$x(0) = 150 + 72.50 - 0 = 222.50 \text{ mm}$$ ✅
   $$y(0) = 100 + 33.81 + 0 = 133.81 \text{ mm}$$ ✅
...
1. **Tangent vector calculation (derivative with respect to t):**
   ...
   $$\frac{dx}{dt} = -72.50\sin(t) - 21.13\cos(t)$$ ✅
   $$\frac{dy}{dt} = -33.81\sin(t) + 45.32\cos(t)$$ ✅

2. **Outward normal vector (perpendicular to tangent, rotated 90° clockwise):**

   For 2D rotation by -90° (clockwise): $(x, y) \rightarrow (y, -x)$

   $$\vec{n}(t) = \begin{bmatrix} \frac{dy}{dt} \\ -\frac{dx}{dt} \end{bmatrix} = \begin{bmatrix} -33.81\sin(t) + 45.32\cos(t) \\ 72.50\sin(t) + 21.13\cos(t) \end{bmatrix}$$ ✅
...
3. **Normal vector magnitude:**
   ...
   At $t = 0°$:
   $$|\vec{n}(0)| = \sqrt{(-21.13)^2 + (45.32)^2} = \sqrt{446.48 + 2053.90} = \sqrt{2500.38} = 50.00 \text{ mm}$$ ✅
...
4. **Unit normal vector:**
   ...
   At $t = 0°$:
   $$\hat{n}(0) = \begin{bmatrix} 45.32/50.00 \\ 21.13/50.00 \end{bmatrix} = \begin{bmatrix} 0.9064 \\ 0.4226 \end{bmatrix}$$ ✅
...
5. **Tool center offset (inside the ellipse for cutting, offset by radius r = 6 mm):**
   ...
   **In complex form:**
   ...
   At $t = 0°$:
   $$x_{tool}(0) = 222.50 - 6(0.9064) = 222.50 - 5.44 = 217.06 \text{ mm}$$ ✅
   $$y_{tool}(0) = 133.81 - 6(0.4226) = 133.81 - 2.54 = 131.27 \text{ mm}$$ ✅

6. **General formula for tool path:**

   $$x_{tool}(t) = 150 + 72.50\cos(t) - 21.13\sin(t) - 6 \cdot \frac{-33.81\sin(t) + 45.32\cos(t)}{\sqrt{(72.50\sin(t) + 21.13\cos(t))^2 + (-33.81\sin(t) + 45.32\cos(t))^2}}$$ ✅

   $$y_{tool}(t) = 100 + 33.81\cos(t) + 45.32\sin(t) - 6 \cdot \frac{72.50\sin(t) + 21.13\cos(t)}{\sqrt{(72.50\sin(t) + 21.13\cos(t))^2 + (-33.81\sin(t) + 45.32\cos(t))^2}}$$ ✅
...
1. **Waypoint parameter spacing:**
   ...
   $$\Delta t = \frac{2\pi}{16} = \frac{360°}{16} = 22.5°$$ ✅
...
2. **Starting point at t = 0° on ellipse (entry point):**
   ...
   $$r_0 = 80.0 \text{ mm}$$ ✅ (calculated above)

   Angle from center:
   $$\theta_0 = \arctan2(133.81 - 100, 222.50 - 150) = \arctan2(33.81, 72.50) = 25.0°$$ ✅
...
5. **Tool offset application to spiral:**
   ...
   $$r_{tool}(\theta) = r(\theta) - 6 = 74.0 - 0.0796\theta$$ ✅
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Mobile Robot Path Planning](https://cdn.siliconwit.com/education/spatial-mechanics/mobile-robot-path.png)
  </TailwindWrapper>
</div>
**What we need to calculate:**
...
<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <TailwindWrapper>
	![Robot Navigation Scenario](https://cdn.siliconwit.com/education/spatial-mechanics/agv-navigation-diagram.png)
  </TailwindWrapper>
</div>
**Given:**
...
1. **Parametric arc equation (Segment 2: P₂ to P₄):**
   ...
   **Arc sweep:** $\Delta\alpha = 17.3° - (-60°) = 77.3°$ ✅
...
2. **Position along arc as function of angle α:**
   ...
   **In Cartesian form:**
   $$x(\alpha) = 1.5 + 3\cos(\alpha)$$ ✅
   $$y(\alpha) = 3.598 + 3\sin(\alpha)$$ ✅
...
3. **Robot orientation along arc (tangent direction):**
   ...
   **Orientation angle:**
   $$\theta(\alpha) = \alpha + 90°$$ ✅ (for counterclockwise arc, left turn)

   **Verification at α = -60° (P₂):**
   $$\theta(-60°) = -60° + 90° = 30°$$ ✅ (matches P₂ orientation)

4. **Arc length calculation:**

   $$s = R \cdot \Delta\alpha_{rad} = 3 \cdot (77.3° \cdot \frac{\pi}{180°})$$
   $$s = 3 \cdot 1.349 = 4.05 \text{ m}$$ ✅

5. **Number of waypoints along arc (0.5 m spacing):**

   $$N = \lceil \frac{s}{0.5} \rceil = \lceil \frac{4.05}{0.5} \rceil = \lceil 8.1 \rceil = 9 \text{ waypoints}$$ ✅
...
1. **Obstacle representation in complex form:**
   ...
   **Total avoidance radius:** $r_{avoid} = r_{obs} + d_{safe} = 2.0$ m ✅
...
5. **Revised arc calculation with R = 4 m:**
   ...
   **Distance from arc center to obstacle center:**
   $$d_{c-obs} = |3 - 2.464i| = \sqrt{9 + 6.07} = \sqrt{15.07} = 3.88 \text{ m}$$ ✅
...
6. **Revised arc with R = 5.5 m:**
   ...
   $$z_{center} = (3 + i) + 5.5 \cdot e^{i120°} = (0.25 + 5.763i)$$ ✅
   ...
   **Correct minimum distance** (from arc to obstacle):
   $$d_{min} = R - d_{c-obs} = 5.5 - 5.31 = 0.19 \text{ m}$$ ❌ Still too close!

7. **Final revised path - go around from the top with R = 3 m, but adjust P₂:**

   **New P₂:** $(2.5, 2)$ with orientation 60°

   **Arc center:**
   $$z_{center} = (2.5 + 2i) + 3 \cdot e^{i150°}$$
   $$z_{center} = (2.5 + 2i) + 3(-0.866 + 0.5i)$$
   $$z_{center} = (-0.098 + 3.5i)$$ ✅

   **Distance from center to obstacle:**
   $$d_{c-obs} = |(4 + 2i) - (-0.098 + 3.5i)| = |4.098 - 1.5i| = \sqrt{16.79 + 2.25} = 4.36 \text{ m}$$ ✅
...
8. **Simpler approach - straight line segments avoiding obstacle:**
   ...
   **Check P₂ clearance:**
   $$d(P_2) = |(3 + 4i) - (4 + 2i)| = |-1 + 2i| = \sqrt{1 + 4} = 2.24 \text{ m}$$ ✅ (> 2.0 m required!)
...
2. **Segment P₁ to P₂ (arc):**
   ...
   **Vector from P₁ to P₂:**
   ...
   $$|\Delta z| = \sqrt{1 + 16} = \sqrt{17} = 4.12 \text{ m}$$ ✅
   ...
   **Arc center perpendicular bisector method:**
   ...
   Direction P₁→P₂: $\phi = \arctan2(4, 1) = 75.96°$
   ...
   **Orientation along segment:**
   $$\theta = \arctan2(4, 1) = 75.96° \approx 76°$$ ✅
