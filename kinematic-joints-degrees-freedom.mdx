...
1. **Classify** all kinematic <Badge text="joint types" variant="caution" /> and their motion characteristics in 3D space
2. **Calculate** <Badge text="degrees of freedom" variant="caution" /> for spatial mechanisms using Grübler's equation
3. **Analyze** <Badge text="constraint relationships" variant="caution" /> and mobility in modular robotic systems  
4. **Design** <Badge text="joint libraries" variant="caution" /> for reconfigurable mechatronic applications
